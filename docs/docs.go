...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ParamLoginEmail"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ParamLoginUsername"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.ParamLoginEmail": {
            ...
            "properties": {
                "email": {
                    "description": "直接利用 Gin 的 email 正则强校验",
                    "type": "string"
                },
                "password": {
                    "type": "string"
